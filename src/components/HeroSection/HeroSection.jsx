...
import BackgroundLight from '../../assets/images/greeting-wave.png';
import BackgroundDark from '../../assets/images/greeting-wave-dark.png';
...
export const HeroSection = () => {
  ...
  return (
    ...
    >
      <div
        className={s.heroSection__background}
        style={{
