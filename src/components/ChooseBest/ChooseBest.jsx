    ...
    <div className={s.container}>
      <div className={s.choosebest__Text}>
        <div className={s.choosebest__TextTitles}>
          <p>выбери <span className={s.choosebest__TextTitlesPink}>лучшее</span> сам!</p>
        </div>
        <p className={s.choosebest__TextParagraph}>Мы предлагаем уникальную возможность создать
        свою тарелку</p>
