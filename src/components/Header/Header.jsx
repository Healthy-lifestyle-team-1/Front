...
export const Header = () => {
  ...
  return (
    <div className={s.header__container}>
      ...
      {isUserModalOpen && <UserPage onClose={handleCloseUserModal} userInfo={userInfo} />}
      {isCartModalOpen && <CartPage onClose={handleCloseCartModal} />}
      {isAuthModalOpen && <Authorization onClose={handleCloseAuthModal} setIsAuthenticated={setIsAuthenticated} />}
    </div>
  );
};