    ...
    const fetchPlates = async () => {
      try {
        const response = await fetch(
          'https://grikoandrey.pythonanywhere.com/product/?name=&category=2&calories=&proteins=&fats=&carbs=&price=&is_prepared=unknown&not_name=&not_calories=&not_proteins=&not_fats=&not_carbs=&not_price=&not_is_prepared=unknown',
        );
