...
export const MainDish = ({ filteredTags }) => {
    ...
    const fetchPlates = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/product/?name=&category=3&calories=&proteins=&fats=&carbs=&price=&is_prepared=&not_name=&not_calories=&not_proteins=&not_fats=&not_carbs=&not_price=&not_is_prepared=`,
        );
